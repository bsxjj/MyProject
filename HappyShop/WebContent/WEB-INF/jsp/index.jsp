...
<%@page import="com.xjj.entity.Product"%>
...
<body>
	...
	<div class="container header">
		...
		<div class="container index">
			<div class="span24">
				<div id="hotProduct" class="hotProduct clearfix">
					...
					<li>
					<a href="${pageContext.request.contextPath }/findByPid?pid=${product.pid}" target="_blank"><img src="${pageContext.request.contextPath }/${product.image}" data-original="http://storage.shopxx.net/demo-image/3.0/201301/0ff130db-0a1b-4b8d-a918-ed9016317009-thumbnail.jpg" style="display: block;">
					</a>
					</li>
					</c:forEach>
					</ul>
			...
			<div class="span24">
				<div id="newProduct" class="newProduct clearfix">
					...
					<!-- 最新商品显示 -->
					<ul class="tabContent" style="display: block;">
						<c:forEach items="${nList}" var="pro">
						<li><a href="${pageContext.request.contextPath }/findByPid?pid=${pro.pid}" target="_blank"><img src="${pro.image}"
		...
		<div class="container footer">
			...
			<div class="span24">
				<div class="copyright">Copyright ©2017 乐购商城 版权所有</div>
			</div>
		</div>
</body>
</html>